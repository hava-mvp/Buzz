var messagebird = require('messagebird')('live_spnliO4i0MNqLiOODnxltv3lL');
...
var sendTextMessage = module.exports.sendTextMessage = function(offer, endTime, barName, callback) {
  getAllRecipients(function(recipients) {
    ...
    var endTimeClean = endTime.replace(/%3A30%/g, ":");

    console.log("barNameClean", barNameClean);
    console.log("offerClean", offerClean);
    console.log("endTimeClean", endTimeClean);
