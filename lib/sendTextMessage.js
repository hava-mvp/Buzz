...
messageBird.checkArrLength = function(arr, barNameClean, offerClean, endTimeClean, callback) {
  ...
  // `Hello! ${barNameClean} has a new offer: ${offerClean}. The offer ends at ${endTimeClean}. Click the link below to get your code.
  // http://hava-mvp.herokuapp.com/#live-offers`
  var params = {
    'originator': 'Hava',
    'body': `Hello!
Our pilot will begin this Saturday 5th March. We’ll let you know via text when you can claim your offers from Balham’s best bars!
Much Love, the Hava Team.`
  };
